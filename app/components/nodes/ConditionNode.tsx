...
const ConditionNode = ({ data }: { data: { label: string; description: string; status: string } }) => {
  ...
  return (
    <div className="px-4 py-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg w-64">
      <div className="flex items-center justify-between mb-2">
        <div className="rounded-lg w-10 h-10 flex justify-center items-center bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-300">
          🔀
        </div>
